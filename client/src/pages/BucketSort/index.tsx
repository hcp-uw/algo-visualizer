...
import { bucketSortDesc } from "../../assets/algorithm-information";
import { RootState } from "../../redux/configureStore";
import { BucketSortResultType } from "../../AlgoResultTypes";
import { ExtraData } from "../../CommonTypes";

const ALGORITHM_URL = "sorts/bucketsort/";

const BucketSort = () => {
  const algorSteps = useSelector(
      (state: RootState) => state.global.algorSteps
  ) as BucketSortResultType;
  ...
  useEffect(() => {
      ...
      dispatch(updateAlgorName(bucketSortDesc.algorithm));
   ...
   /**
     ...
     * used for the logger.
     *
     * For bucket sort, each step includes the following:
     *
     *
     * algorSteps.steps[i] =
    //     steps: {
   ...
   const drawBlocks = () => {
    ...
    let isStepAvailable =
        ...
        currentName === bucketSortDesc.algorithm;
    ...
    // TODO: Change the below to match the result
  ...
  return (
        <div className="content">
            <div className="centered">
                <AlgorithmPopover data={bucketSortDesc} />
            </div>

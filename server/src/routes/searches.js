...
router.post("/depthfirstsearch", (req, res) => {
    let r = searches.depthFirstSearch(req.body.nodes, req.body.edges, "", req.body.target);
    res.status(200).send({
        result: r,
    });
});
...
router.post("/breadthfirstsearch", (req, res) => {
    let r = searches.breadthFirstSearch(req.body.nodes, req.body.edges, "", req.body.target);
    res.status(200).send({
        result: r,
    });
});
